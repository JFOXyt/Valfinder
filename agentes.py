...
def butaoagentes(root,img,result_labels,gray):
    ...
    def butaosearch():
        ...
        if url.status_code==200 and entryget!='':
            ...
            for i in range(lenagent):
                pegarnomeagente=response['data'][i]['displayName'].lower()
                ...
                if entryget==pegarnomeagente and isplayable:
                    ...
                    for a in range(abilitylen):
                        ...
                        abilityicondimension=Image.open(img[5])
                        ...
                        if dimensao==1024:
                            ...
                            print('oh no',dimensao)

                        abilityiconp=tkinter.PhotoImage(file=img[6]).subsample(dimensoes,dimensoes)
