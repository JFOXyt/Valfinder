...
butaobundles=tkinter.Button(root,text='Bundles'
                            ,bg=valred,fg=valblack
                            ,font=('Arial',22,'bold')
                            ,border=0)

butaobundles.place(x=widthbutons*2,y=200,width=widthbutons,height=80)



butaobudies=tkinter.Button(root,text='Buddies'
                           ,bg=valred,fg=valblack
                           ,font=('Arial',22,'bold')
                           ,border=0)

butaobudies.place(x=widthbutons*3,y=200,width=widthbutons,height=80)


butaomaps=tkinter.Button(root,text='Maps'
                         ,bg=valred,fg=valblack
                         ,font=('Arial',22,'bold')
                         ,border=0)

butaomaps.place(x=widthbutons*4,y=200,width=widthbutons,height=80)


butaosprays=tkinter.Button(root,text='Sprays'
                           ,bg=valred,fg=valblack
                           ,font=('Arial',22,'bold')
                           ,border=0)

butaosprays.place(x=widthbutons*5,y=200,width=widthbutons,height=80)


butaocards=tkinter.Button(root,text='Cards'
                          ,bg=valred,fg=valblack
                          ,font=('Arial',22,'bold')
                          ,border=0)

butaocards.place(x=widthbutons*6,y=200,width=widthbutons,height=80)
